...
class IA_ESNW:
    ...
    def action(self, game_dict: dict) -> str:
        ...
        coût = (coders[current_player_number]['level'] + 1) ** 2 * COST_UPGRADE
        ...
        current_level = coders[current_player_number]['level']
        current_max_energy = coders[current_player_number]['max_energy']
        ...
        if current_energy > 0:
            ...
            position_x_vise = 100  # On initialise une valeur visée infinie positive pour inclure toute mission possible
            position_y_vise = 100
            ...
            for mission_position, mission in missions_positions.items():  # Lance une boucle pour constemment surveiller la liste
                ...
                if mission_position != current_position:
                    ...
                    if differencex + differencey < abs(position_x_vise - current_position[0]) + abs(position_y_vise - current_position[1]) and mission['cooldown'] < 2 and mission['difficulty'] > 1:
